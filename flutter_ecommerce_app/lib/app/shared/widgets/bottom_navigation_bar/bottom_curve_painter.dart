...
import 'package:flutter_ecommerce_app/app/shared/widgets/bottom_navigation_bar/bottom_elastic_out_curve.dart';
...
class BottomCurvePainter extends CustomPainter {
  ...
  BottomCurvePainter(double x, double normalizedY, Color color)
      : _x = x,
  ...
  @override
  bool shouldRepaint(BottomCurvePainter oldPainter) {
